...
import { Plus, Trash2, ShieldCheck, CalendarCheck, FileLock2, History } from "lucide-react";
  ...
  return (
    <div className="container max-w-3xl py-6">
      <PageHeader
        ...
        title="Trusted contacts & access"
        description="Tiered access, a local check-in, and encrypted handover packages."
      />
