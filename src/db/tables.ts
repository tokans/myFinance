...
export const T = {
  ...
  aisSft: "myfinance_ais_sft",
  taxRefunds: "myfinance_tax_refunds",
  taxCaComputation: "myfinance_tax_ca_computation",
  reconLinks: "myfinance_recon_links",
  categoryRules: "myfinance_category_rules",
  transactionTags: "myfinance_transaction_tags",
  customOptions: "myfinance_custom_options",
  people: "myfinance_people",
  personFacet: "myfinance_person_facet",
